...
streams = [
    ("/Volumes/bridge_data_monitoring/00_landing/streaming/bridge_temperature",  "temperature",  19,  23),
    ("/Volumes/bridge_data_monitoring/00_landing/streaming/bridge_vibration",    "vibration",    0.005, 0.05),
    ("/Volumes/bridge_data_monitoring/00_landing/streaming/bridge_tilt",         "tilt_angle",   -0.005, 0.005)
]

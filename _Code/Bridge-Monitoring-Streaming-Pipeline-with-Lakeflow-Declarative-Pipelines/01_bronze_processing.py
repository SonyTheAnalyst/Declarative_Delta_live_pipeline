...
def bronze_bridge_temperature():
    return (
        spark.readStream
             .format("delta")
             .load("/Volumes/bridge_data_monitoring/00_landing/streaming/bridge_temperature")
    )
...
def bronze_bridge_vibration():
    return (
        spark.readStream
             .format("delta")
             .load("/Volumes/bridge_data_monitoring/00_landing/streaming/bridge_vibration")
    )
...
def bronze_bridge_tilt():
    return (
        spark.readStream
             .format("delta")
             .load("/Volumes/bridge_data_monitoring/00_landing/streaming/bridge_tilt")
    )
